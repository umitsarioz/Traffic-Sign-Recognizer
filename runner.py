...
from prod.preprocess import Preprocessor
from prod.train import Trainer


def run(skip_preprocess=False, skip_train=False):
    processor_obj = Preprocessor(root_filepath=join('dataset'), train_filename='Train.csv', test_filename='Test.csv')
...
if __name__ == "__main__":
    run(skip_preprocess=True, skip_train=False)
